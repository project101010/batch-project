...
<div class="container-fluid bg-grey" style="background:#ffe4c4;">
  <div class="row" style="background:#ffe4c4;">
    <div class="col-sm-4"style="background:#ffe4c4;">
      <span class="glyphicon glyphicon-globe logo slideanim"></span>
    </div>
    <div class="col-sm-8" style="background:#ffe4c4;">
      <h2>Our Values</h2><br>
...
<div id="developers" class="container-fluid text-center bg-grey" style="background:#ffe4c4;">
  <h2>Developers</h2><br>
  <h4>Who are we</h4>
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="img\Hero_Tom.png" alt="G.Tapaswi" height="100" width="100">
        <p><strong>G.Tapaswi</strong></p>
        <p><strong>231FA04903</strong></p>
        <p>Vignan University 2nd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="img\Hero_SportMan.png" alt="N. Praveen Sai" height="100" width="100">
        <p><strong>N. Praveen Sai</strong></p>
        <p><strong>231FA04930</strong></p>
        <p>Vignan University 2nd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="img\Hero_MonkeyKing.png" alt="P. Gnaneswar" height="100" width="100">
        <p><strong>P. Gnaneswar</strong></p>
        <p><strong>231FA04964</strong></p>
        <p>Vignan University 2nd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="img\Hero_Farmer.png" alt="E. Raghu" height="100" width="100" >
        <p><strong>E. Raghu</strong></p>
        <p><strong>231FA04A10</strong></p>
        <p>Vignan University 2nd year BTECH</p>
      </div>
    </div>
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>sreekar penugonda, Comment Box</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>vivek</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>hemanth</span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey" ba-col>
  ...
  <div class="row">
    <div class="col-sm-5" >
      ...
      <p><span class="glyphicon glyphicon-envelope"></span> batch10fieldproject@gmail.com</p>
    </div>
  ...
  if(isset($_GET['q']) && !empty($_GET['q'])) { 
    echo '<span style="font-size:18px; color: green;">
            <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 
            &nbsp;'.htmlspecialchars($_GET['q']).'
          </span>';
    echo '<br><a href="index.php">Go back</a>'; // Add a link to refresh the form
  } else { 
?>
    <form role="form" method="post" action="feed.php?q=index.php">
      ...
      <textarea class="form-control" id="comments" name="feedback" placeholder="Comment" rows="4" required></textarea><br>
      <div class="row">
